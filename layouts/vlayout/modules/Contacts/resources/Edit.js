...
Vtiger_Edit_Js("Contacts_Edit_Js",{},{
    ...
    getMobile : function(container){
        return jQuery('input[name="cf_823"]',container).val();
    },

    getEmail : function(container){
        return jQuery('input[name="cf_827"]',container).val();
    },
    /**
            ...
            if(!(accountName in thisInstance.duplicateCheckCache)) {
                Vtiger_Helper_Js.checkDuplicateName({
                    ...
                    function(data, err){
                        ...
                        // alert(error_custom_message+"__"+error_custom_status);
