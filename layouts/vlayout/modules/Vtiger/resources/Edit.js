...
jQuery.Class("Vtiger_Edit_Js",{
    ...
    registerEventForPicklistEvents : function(container) {
       ...
       var Recruitment_block = container.find('.Recruitment_block');
		...
		if($('#Contacts_editView_fieldName_cf_763').attr('checked') == 'checked')
		Recruitment_block.show();
		
		if($('#Contacts_editView_fieldName_cf_765').attr('checked') == 'checked')
		Marketing_block.show();
		
		if($('#Contacts_editView_fieldName_donotcall').attr('checked') == 'checked')
		Education_block.show();
		
		if($('#Contacts_editView_fieldName_reference').attr('checked') == 'checked')
		Government_block.show();
		
		if($('#Contacts_editView_fieldName_notify_owner').attr('checked') == 'checked')
		Social_block.show();
...
function ValidateCustomFields() {
	$('#Contacts_editView_fieldName_cf_823').keyup(function() {
		...
		$('#Potentials_editView_fieldName_potentialname').keyup(function() {
			//$('span.error-keyup-1').hide();
			var inputVal = $(this).val();
