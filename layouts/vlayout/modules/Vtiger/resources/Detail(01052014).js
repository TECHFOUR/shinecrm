...
function showSalesapprovalDatabase(str)
{
	...
	if (str=="")
		...
		xmlhttp.open("GET","get_salesapproval_database.php?product_type="+str,false);
		xmlhttp.send(false);
...
//Add by Raghvender Singh on 30042014
function showApprovalinformationDatabase(str)
{
	...
	if (str=="")
		...
		xmlhttp.open("GET","get_approvalinformation_database.php?record="+str,false);
		xmlhttp.send(false);
