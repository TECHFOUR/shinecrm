...
<div  class="summaryWidgetContainer">
	<div class="widget_header row-fluid">
		...
		{*<!--Modified by Raghvender Singh on 24042014-->*}
        ...
        <span class="span4"><a class="btn pull-right addButton" href="index.php?module=Calendar&view=Edit&mode=Events&sourceModule=Contacts&sourceRecord={$LINK_RECORD}&relationOperation=true&picklistDependency=[]&                        defaultCallDuration=10&defaultOtherEventDuration=5&activitytype=&subject=&eventstatus=&date_start=&time_start=&due_date=&time_end=&assigned_user_id=&cf_917=&cf_919=&cf_921=&cf_923=&cf_925=&contact_id={$LINK_RECORD}&sourceModule=Contacts&sourceRecord={$LINK_RECORD}&relationOperation=true" type="button"><strong>{vtranslate('LBL_ADD',$MODULE_NAME)}</strong></a></span>
	</div>
