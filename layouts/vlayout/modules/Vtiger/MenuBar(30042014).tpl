			...
			<div class="menuBar row-fluid">
				...
				<div class="span9" style="overflow: hidden;">
					<ul class="nav modulesList">
                        ...
                        <!-- Start code for popup by jitendra singh on 5 April 2014 -->  
                        <li>
                        {include file="CalculatorForm.tpl"|@vtemplate_path:"Campaigns"}
                        </li>
                          <!-- End code for popup by jitendra singh on 5 April 2014 -->    
					</ul>
