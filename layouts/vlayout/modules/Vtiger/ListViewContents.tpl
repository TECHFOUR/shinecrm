...
<div class="listViewEntriesDiv contents-bottomscroll">
	...
	<table class="table table-bordered listViewEntriesTable">
		...
		{foreach item=LISTVIEW_ENTRY from=$LISTVIEW_ENTRIES name=listview}
     	...
     	<tr class="listViewEntries" data-id='{$LISTVIEW_ENTRY->getId()}' data-recordUrl='{$LISTVIEW_ENTRY->getDetailViewUrl()|cat:'&mode=showDetailViewByMode&requestMode=full'}' id="{$MODULE}_listView_row_{$smarty.foreach.listview.index+1}">
        {*<!--Add by Raghvender Singh on 03052014-->*}
