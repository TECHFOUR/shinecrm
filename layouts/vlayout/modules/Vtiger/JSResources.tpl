...
{* <script> resources below *}
    ...
    <script type="text/javascript" src="libraries/jquery/datetimepicker_css.js"></script> <!-- [TECHFOUR] -->
    ...
    <!--Start Code added for calculator from jitendra singh -->
	<script type="text/javascript" src="calculator/javascripts/myjs.js"></script>
    <!--Start Code added for calculator from jitendra singh -->
