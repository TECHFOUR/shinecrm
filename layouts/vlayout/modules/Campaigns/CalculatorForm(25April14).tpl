...
<option>ELITE MIND & SHINE VERIFIED</option>
...
<td >Month</td>
<td>
<input type="text" name="print_month" id="print_month" />
 </td>
</tr>
...
<td>
<select name="upsell_excel" id="upsell_excel" onchange="get_upsell_excel(this.value);">
<option>Select an Option</option>
...
<td>
<select name="downsell_excel" id="downsell_excel" onchange="get_downsell_excel(this.value);">
<option>Select an Option</option>
<option value="1">3K</option>
<option value="2">6K</option>
<option value="3">9K</option>
...
<td>Upsell Word(K)</td>
<td>
<select name="upsell_word" id="upsell_word" onchange="get_upsell_word(this.value);">
<option>Select an Option</option>
...
<td>
<select name="downsell_word" id="downsell_word" onchange="get_downsell_word(this.value);">
<option>Select an Option</option>
<option value="1">2K</option>
<option value="2">4K</option>
<option value="3">6K</option>
...
<td>
<select name="upsell_emailer" id="upsell_emailer" onchange="get_upsell_emailer(this.value);">
<option>Select an Option</option>
...
<td>
<select name="downsell_emailer" id="downsell_emailer" onchange="get_downsell_emailer(this.value);">
<option>Select an Option</option>
<option value="1">5K</option>
<option value="2">10K</option>
<option value="3">15K</option>
...
<td><input type="text" name="elitemind_requirement" id="elitemind_requirement" readonly="readonly"/></td>
