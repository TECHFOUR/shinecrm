				...
				<div class="span12">
					<div class="content-wrapper">
						<div class="container-fluid">
							<div class="row-fluid">
								<div class="span6">
									<div class="carousal-container" style="margin-top:140px;"><img src="layouts/vlayout/skins/images/shinelogo.png">
								...
								<div class="span6">
									<div class="login-area" style="color:#FBDC0F">
										<div class="login-box" id="loginDiv" style="background: #4A4A4A">
											<div class="" >
												<h3 class="login-header" >Login to Shine CRM</h3>
											</div>
											<form class="form-horizontal login-form" style="margin:0;" action="index.php?module=Users&action=Login" method="POST">
												...
												<div class="control-group" >
													<label class="control-label" for="username" style="color:#FBDC0F"><b>User name</b></label>
													<div class="controls">
												...
												<div class="control-group">
													<label class="control-label" for="password" style="color:#FBDC0F"><b>Password</b></label>
													<div class="controls">
												...
												<div class="control-group signin-button">
													<div class="controls" id="forgotPassword">
														<button type="submit"  style="background-color: #FBDC0F">Sign in</button>
														&nbsp;&nbsp;&nbsp;
                                                       <!-- <a>Forgot Password ?</a>-->
													</div>
												</div>
