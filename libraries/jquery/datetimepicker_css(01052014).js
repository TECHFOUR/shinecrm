...
var WeekHeadColor = "#06529E"; //var WeekHeadColor="#18861B";//Background Color in Week header.
var SundayColor = "#c9effb"; //var SundayColor="#C0F64F";//Background color of Sunday.
var SaturdayColor = "#c9effb"; //Background color of Saturday.
var WeekDayColor = "#c9effb"; //Background color of weekdays.
var FontColor = "blue"; //color of font in Calendar day cell.
var TodayColor = "#ffbd35"; //var TodayColor="#FFFF33";//Background color of today.
var SelDateColor = "#e5eecc"; //var SelDateColor = "#8DD53C";//Backgrond color of selected date in textbox.
...
function RenderCssCal(bNewCal)
{
    ...
    {
        vCalHeader += "<td align='center'><select style='width:90px !important;' name='MonthSelector' onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();'>";
        for (i = 0; i < 12; i += 1)
        {
            if (i === Cal.Month)
            {
        ...
        vCalHeader += "<td align='center'><select style='width:90px !important;' name='YearSelector' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();'>";
...
<!--Add by Raghvender Singh on 28042014-->
function checkDate(val,dateformat,id) {
...
var yesterday = new Date(new Date().getTime() - 24 * 60 * 60 * 1000);
				...
				alert('Expected Closer date should be equal or grater then current date.');
				document.getElementById(id).value='';
				           }
}	
<!-- End Add by Raghvender Singh on 28042014
