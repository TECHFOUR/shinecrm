...
jQuery.Class("Vtiger_Helper_Js",{
     ...
     */
    showConfirmationBoxContactCustom : function(data){
        var aDeferred = jQuery.Deferred();
        //var bootBoxModal = bootbox.alert('CSAF No already exist.');
        var bootBoxModal = bootbox.alert(data['message']+" "+error_custom_message+".");
    ...
    showConfirmationBoxCustom : function(data){
        var aDeferred = jQuery.Deferred();
        //var bootBoxModal = bootbox.alert('CSAF No already exist.');
    ...
    checkDuplicateName : function(details) {
        ...
        var key_contact = details.key_contact;
