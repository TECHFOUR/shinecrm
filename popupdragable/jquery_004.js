...
$.Window = (function()  {
	...
	function constructor(caller, options) {
		...
		var options = $.extend({
			...
			x: 17,   // Changed by ISHWAR                       // [number:-1] the x-axis value on screen(or caller element), if -1 means put on screen(or caller element) center
			y: 75,                        // [number:-1] the y-axis value on screen(or caller element), if -1 means put on screen(or caller element) center
			z: 2000,                      // [number:2000] the css z-index value
			width: 218,                   // [number:400] window width
			height: 550,                  // [number:300] window height
			...
			showModal: false,     // Change By Ishwar         // [boolean:false] to control show modal on background
			modalOpacity: 0.5,            // [number:0.5] the opacity of modal dialog
			showFooter: true,             // [boolean:true] to control show footer panel
			showRoundCorner: true,  // Changed by ISHWAR default value is false     // [boolean:true] to control display window as round corner
			closable: false, // Changed By Ishwar default value is true              // [boolean:true] to control window closable
			minimizable: true,            // [boolean:true] to control window minimizable
			maximizable: false,  // Change by ISHWAR           // [boolean:true] to control window maximizable
			...
			scrollable: false,  // Change by ISHWAR             // [boolean:true] to control show scroll bar or not
