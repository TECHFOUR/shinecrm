...
class Products extends CRMEntity {
	...
	var $list_fields = Array(
		'Contact Person'=>Array('products'=>'productname'),
		'Mobile No.'=>Array('productcf'=>'mobile'),
		'Email'=>Array('productcf'=>'email'),
		'City'=>Array('productcf'=>'city'),
		'Country'=>Array('productcf'=>'country')
	);
	var $list_fields_name = Array(
        'Contact Person'=>'productname',
        'Mobile No.'=>'mobile',
        'Email'=>'email',
        'City'=>'city',
        'Country'=>'country'
