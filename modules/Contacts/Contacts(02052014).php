...
class Contacts extends CRMEntity {
    ...
    var $search_fields = Array(
        ...
        'Type of Client' => Array('contactsubdetails'=>'leadsource'),

        'Key Contact Person' => Array('contactscf'=>'cf_819'),

        'Free Job Client' => Array('contactscf'=>'free_job_client'),

        'Client Status'=>Array('contactscf'=>'client_status')
    ...
    var $search_fields_name = Array(
        ...
        'Type of Client' => 'leadsource',

        'Key Contact Person' => 'cf_819',

        'Free Job Client' => 'free_job_client',
