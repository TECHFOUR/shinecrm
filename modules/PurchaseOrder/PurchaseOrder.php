...
class PurchaseOrder extends CRMEntity {
	...
	var $list_fields = Array(
				...
				'Branch City'=>Array('purchaseordercf'=>'branch_city'),
				'Branch Region'=>Array('purchaseorder'=>'branch_region'),
				'Branch Contact'=>Array('purchaseorder'=>'branch_contact'),
				'Branch Address'=>Array('purchaseorder'=> 'branch_address'),
	...
	var $list_link_field= 'branch_city';
	...
	var $required_fields =  array("branch_city"=>1);

	//Added these variables which are used as default order by and sortorder in ListView
	var $default_order_by = 'branch_city';
	var $default_sort_order = 'ASC';

	// For Alphabetical search
	var $def_basicsearch_col = 'branch_city';
