...
class Activity extends CRMEntity {
	...
	function save_module($module)
	{
      // echo "<pre>";print_r($_REQUEST);die;
        ...
        if($_REQUEST['sourceModule'] == "Contacts")
            $this->column_fields['contact_id'] = $_REQUEST['sourceRecord'];
        ...
        if(isset($_REQUEST) && $_REQUEST['record'] == "" && $_REQUEST['sourceModule'] == "Contacts") // create new lead
            $this->createNewLead();
	}	
