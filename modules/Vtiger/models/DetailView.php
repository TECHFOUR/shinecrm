...
class Vtiger_DetailView_Model extends Vtiger_Base_Model {
    ...
    public function getDetailViewLinks($linkParams) {
        ...
        if($moduleName == "Calendar") {
            $relatedLinks[2]['linktype'] = "DETAILVIEWRELATED";
            $relatedLinks[2]['linklabel'] = "Leads";
            $relatedLinks[2]['linkurl'] = "module=Events&relatedModule=Leads&view=Detail&record=$recordId&mode=showRelatedList";
            $relatedLinks[2]['linkicon'] = "";
        }
        // echo "<pre>";print_r($relatedLinks);die;
